...
[chatroom user="user" room="chatroom" width="100%" height="500px"]
You can configure the user name and chatroom but after that any user can change the username or the chat room. Also you can modify the height and width of the shortcode.

We use a third party service from https://kiwiirc.com to display the chat and connect to the chathispano network chatrooms.

This plugin does not store any  data from you or from the chat conversations.
You can read the Kiwiirc privacy Police https://kiwiirc.com/privacy
...
The plugin will display a ustom window inside that page or post with your configuration
[chatroom user="user" room="chatroom" width="100%" height="500px"]
user: name of the user
room: name of the chat room like your domain.com
width: The width of the chatroom. The most common option is 100% to adapt to your theme.
height: the height of the chatroom. The most common option is between 500px and 700px. You must check the best height for your design.
